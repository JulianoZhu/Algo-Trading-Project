...
turn StandardScaler off by setting its parameters (with_mean and with_std to False)
...
Construct an index to include the remaining numerical columns (float64) in dfs i.e. the lags
...
param_grid =  [{'prep__wav__kw_args': scales_rs, 'prep__pca__n_components':ncomponents_rs, 'rforest__max_depth': nestimators_rs}]
